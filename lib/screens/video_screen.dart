...
class VideoScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    // print(videoStream.value![0].commentCount.toString());
    // print(videoStream.value![0].id.toString());
    // print(videoStream.value![0].likes.length.toString());
    // print(videoStream.value![0].profilePhoto.toString());
    // print(videoStream.value![0].shareCount.toString());
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  buildProfile( videosList[index].profilePhoto ?? 'https://www.postmalone.com/files/2022/05/Rectangle-8-1.png'),
                                  Column(
                                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                    children: [
                                      InkWell(
                                        child: Icon(
                                          ...
                                          Text(videosList[index].likes.length.toString(),style: TextStyle(fontSize: 20,color: Colors.white),),
                                          SizedBox(height: 10,),
                                        ...
                                        child: Icon(
                                          ...
                                          const SizedBox(height: 7,),
                                          Text(videosList[index].commentCount.toString(),style: TextStyle(fontSize: 20,color: Colors.white),),
                                          SizedBox(height: 10,),
                                        ...
                                        child: Icon(
                                          ...
                                          const SizedBox(height: 7,),
                                          Text(videosList[index].shareCount.toString(),style: TextStyle(fontSize: 20,color: Colors.white),),
                                          SizedBox(height: 35,),
